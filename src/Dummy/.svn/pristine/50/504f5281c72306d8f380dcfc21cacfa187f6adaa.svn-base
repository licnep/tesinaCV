...
set(CPACK_INSTALL_CMAKE_PROJECTS "${PACKAGE_BUILD_DIR};${PACKAGE_NAME};${COMPONENT};/opt/gold-4.6.0/lib64/gold-4.6.0/plugins/")
...
# usare questa riga per applicazioni con più components
...
set(CPACK_PACKAGE_FILE_NAME "${PACKAGE_NAME}-${PACKAGE_VERSION}-${PACKAGE_RELEASE}.${PACKAGE_SYSTEM_PROCESSOR}.${PACKAGE_TARGET_OS}")
